...
def read_configuration(
    filepath, find_others: bool = ..., ignore_option_errors: bool = ...
): ...
def configuration_to_dict(handlers): ...
def parse_configuration(
    distribution, command_options, ignore_option_errors: bool = ...
): ...
...
class ConfigHandler:
    ...
    set_options: Any
    def __init__(
        self, target_obj, options, ignore_option_errors: bool = ...
    ) -> None: ...
    @property
