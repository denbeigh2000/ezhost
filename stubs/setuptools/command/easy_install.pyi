...
class easy_install(Command):
    ...
    def install_item(
        self, spec, download, tmpdir, deps, install_needed: bool = ...
    ): ...
    def select_scheme(self, name) -> None: ...
    def process_distribution(
        self, requirement, dist, deps: bool = ..., *info
    ) -> None: ...
    def should_unzip(self, dist): ...
    def maybe_move(self, spec, dist_filename, setup_base): ...
    def install_wrapper_scripts(self, dist) -> None: ...
    def install_script(
        self, dist, script_name, script_text, dev_path: Any | None = ...
    ) -> None: ...
    def write_script(
        self, script_name, contents, mode: str = ..., blockers=...
    ) -> None: ...
...
class ScriptWriter:
    ...
    @classmethod
    def get_script_args(
        cls, dist, executable: Any | None = ..., wininst: bool = ...
    ): ...
    @classmethod
    def get_script_header(
        cls, script_text, executable: Any | None = ..., wininst: bool = ...
    ): ...
    @classmethod
